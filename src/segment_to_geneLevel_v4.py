'''
    ...
    # The logic of this script replicates that of the simple copy number caller from the GATK package function: CallCopyRatioSegments
    # It uses weighted copy numbers to assign copy ratios and calls to genes that intersect more than one segment.
